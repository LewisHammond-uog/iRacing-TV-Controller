...
namespace iRacingTVController
{
	public class NormalizedSession
	{
		...
		public string trackMapTextureUrl = string.Empty;
		...
		public void SessionUpdate()
		{
			...
			seriesLogoTextureUrl = $"https://ir-core-sites.iracing.com/members/member_images/series/leagueid_{IRSDK.session.WeekendInfo.LeagueID}/logo.jpg";
			trackLogoTextureUrl = DataApi.GetTrackLogoUrl( trackID.ToString() );
			trackMapTextureUrl = DataApi.GetTrackMapLayerUrl(trackID, "active");
