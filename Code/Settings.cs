	...
	public static class Settings
	{
		...
		public static void FixSettings( SettingsOverlay settings )
		{
			...
			var defaultTextSettings = new Dictionary<string, SettingsText>()
			{
				...
				{ "IntroDriverTextLayer6", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 27, position = { x = -179, y = 81 }, tintColor = { b = 0, a = 0.75f }, content = SettingsText.Content.ThisCar_LeaderboardClass } },
