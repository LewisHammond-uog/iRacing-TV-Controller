	...
	public static class Settings
	{
		...
		public static void FixSettings( SettingsOverlay settings )
		{
			...
			var defaultTextSettings = new Dictionary<string, SettingsText>()
			{
				...
				{ "BattleChyronTextLayer2", new SettingsText() { fontIndex = SettingsText.FontIndex.FontB, fontSize = 42, position = { x = 100, y = 19 }, content = SettingsText.Content.Driver_FamilyName } },
				{ "BattleChyronTextLayer3", new SettingsText() { fontIndex = SettingsText.FontIndex.FontB, fontSize = 25, position = { x = 100, y = 60 }, tintColor = { r = 0.5f, g = 0.5f, b = 0.5f }, content = SettingsText.Content.ThisCar_LeaderboardClass } },
				{ "BattleChyronTextLayer4", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 36, position = { x = 100, y = 119 }, tintColor = { r = 1f, g = 0f, b = 0f }, content = SettingsText.Content.Driver_CarBehind_GapTime} },
				{ "BattleChyronTextLayer5", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 36, position = { x = 100, y = 84 }, tintColor = { r = 0f, g = 1f, b = 0f }, content = SettingsText.Content.Driver_CarInFront_GapTime } },
				...
				{ "ChyronTextLayer4", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 36, position = { x = 100, y = 119 }, content = SettingsText.Content.ThisCar_LeaderboardClass, useClassColors = true} },
				...
				{ "IntroDriverTextLayer6", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 27, position = { x = -179, y = 81 }, tintColor = { b = 0, a = 0.75f }, content = SettingsText.Content.Driver_QualifyPosition_Class, useClassColors = true } },
