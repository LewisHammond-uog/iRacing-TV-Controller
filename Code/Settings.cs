	...
	public static class Settings
	{
		...
		public static void FixSettings( SettingsOverlay settings )
		{
			...
			var defaultImageSettings = new Dictionary<string, SettingsImage>() {
				...
				{ "RaceResultLayer1", new SettingsImage() { imageType = SettingsImage.ImageType.None, filePath = Program.documentsFolder + "Assets\\default\\leaderboard-heading.png", position = { x = -512, y = 0 }, size = { x = 1024, y = 72 }, border = { x = 24, y = 24, z = 24, w = 24 }, useClassColors = true } },
			...
			var defaultTextSettings = new Dictionary<string, SettingsText>()
			{
				...
				{ "ChyronTextLayer4", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 36, position = { x = 100, y = 119 }, content = SettingsText.Content.ThisCar_LeaderboardClass } },
				...
				{ "IntroDriverTextLayer1", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 76, position = { x = -180, y = -167 }, content = SettingsText.Content.Driver_OverallQualityPosition_WithP } },
				...
				{ "IntroDriverTextLayer5", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 27, position = { x = -50, y = 81 }, tintColor = { b = 0.3f, a = 0.75f }, content = SettingsText.Content.ThisCar_LeaderboardClass } },
				{ "IntroDriverTextLayer6", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 27, position = { x = -179, y = 81 }, tintColor = { b = 0, a = 0.75f }, content = SettingsText.Content.Driver_QualifyPosition_WithP } },
				...
				{ "RaceResultPositionTextLayer4", new SettingsText() { fontIndex = SettingsText.FontIndex.FontC, fontSize = 60, alignment = TextAlignmentOptions.TopRight, position = { x = 449, y = 0 }, tintColor = { r = 0.69f, g = 0.71f, b = 0.694f }, content = SettingsText.Content.Driver_Telemetry } },
