	...
	public static class Settings
	{
		...
		public static void FixSettings( SettingsOverlay settings )
		{
			...
			var defaultTextSettings = new Dictionary<string, SettingsText>()
			{
				...
				{ "LeaderboardPositionTextLayer5", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 21, alignment = TextAlignmentOptions.TopLeft, position = { x = 330f, y = 12 }, tintColor = { r = 0.69f, g = 0.71f, b = 0.694f }, content = SettingsText.Content.Driver_ExtraInfo } },
