	...
	public static class Settings
	{
		...
		public static void FixSettings( SettingsOverlay settings )
		{
			...
			var defaultImageSettings = new Dictionary<string, SettingsImage>() {
				{ "BattleChyronBackground", new SettingsImage() { imageType = SettingsImage.ImageType.ImageFile, filePath = Program.documentsFolder + "Assets\\default\\generic-background-col.png", size = { x = 500, y = 178 }, border = { x = 24, y = 24, z = 24, w = 24 } } },
				...
				{ "ChyronBackground", new SettingsImage() { imageType = SettingsImage.ImageType.ImageFile, filePath = Program.documentsFolder + "Assets\\default\\generic-background-col.png", size = { x = 500, y = 178 }, border = { x = 24, y = 24, z = 24, w = 24 } } },
				...
				{ "Custom1Layer1", new SettingsImage() {imageType = SettingsImage.ImageType.TrackImage} },
				...
				{ "RaceResultBackground", new SettingsImage() { imageType = SettingsImage.ImageType.ImageFile, filePath = Program.documentsFolder + "Assets\\default\\overlay-generic-fullscreen.png", position = { x = -1000, y = 0 }, size = { x = 2024, y = 400 }, border = { x = 24, y = 24, z = 24, w = 24 }, useClassColors = false } },
				{ "RaceResultLayer1", new SettingsImage() { imageType = SettingsImage.ImageType.None, filePath = Program.documentsFolder + "Assets\\default\\leaderboard-heading.png", position = { x = -1000, y = 0 }, size = { x = 2024, y = 72 }, border = { x = 24, y = 24, z = 24, w = 24 }, useClassColors = true } },
				...
				{ "RaceResultPositionLayer1", new SettingsImage() { imageType = SettingsImage.ImageType.Helmet, position = { x = -800, y = 10 }, size = { x = 90, y = 50 } } },
				...
				{ "RaceStatusOneToGreen", new SettingsImage() { imageType = SettingsImage.ImageType.ImageFile, filePath = Program.documentsFolder + "Assets\\default\\one-to-green.png", size = { x = 319, y = 219 }, } },
			...
			{
				{ "BattleChyronTextLayer1", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 40, position = { x = 53, y = 97 }, alignment = TextAlignmentOptions.Top, useClassColors = true, content = SettingsText.Content.Driver_Position_Ordinal } },
				...
				{ "BattleChyronTextLayer4", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 28, position = { x = 100, y = 119 }, tintColor = { r = 1f, g = 0f, b = 0f }, content = SettingsText.Content.Driver_CarBehind_GapTime} },
				{ "BattleChyronTextLayer5", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 28, position = { x = 100, y = 84 }, useClassColors = true, content = SettingsText.Content.Driver_CarInFront_GapTime } },
				...
				{ "ChyronTextLayer1", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 40, position = { x = 53, y = 97 }, alignment = TextAlignmentOptions.Top, useClassColors = true, content = SettingsText.Content.Driver_Position_Ordinal } },
				...
				{ "ChyronTextLayer3", new SettingsText() { fontIndex = SettingsText.FontIndex.FontB, fontSize = 25, position = { x = 100, y = 60 }, tintColor = { r = 200f/255f, g = 162f/255f, b = 200f/255f }, content = SettingsText.Content.Driver_FamilyName } },
				{ "ChyronTextLayer4", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 28, position = { x = 100, y = 119 }, content = SettingsText.Content.ThisCar_LeaderboardClass, useClassColors = true} },
				{ "ChyronTextLayer5", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 36, position = { x = 100, y = 84 }, content = SettingsText.Content.Driver_LapTime_Current } },
				{ "ChyronTextLayer6", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 21, position = { x = 250, y = 130}, content = SettingsText.Content.Driver_Sectors} },
				...
				{ "Custom1TextLayer1", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 42, content = SettingsText.Content.Track_Name, alignment = TextAlignmentOptions.Center} },
				{ "Custom1TextLayer2", new SettingsText() { fontIndex = SettingsText.FontIndex.FontC, fontSize = 30, content = SettingsText.Content.Track_CityCounty, tintColor = { r = 200f/255f, g = 162f/255f, b = 200f/255f }, alignment = TextAlignmentOptions.Center} },
				{ "Custom1TextLayer3", new SettingsText() { fontIndex = SettingsText.FontIndex.FontC, fontSize = 25, content = SettingsText.Content.Track_ExtraInfo}},
				...
				{ "IntroDriverTextLayer1", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 76, position = { x = -180, y = -167 }, content = SettingsText.Content.Driver_OverallQualityPosition_WithP, useClassColors = true} },
				...
				{ "IntroDriverTextLayer5", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 27, position = { x = -50, y = 81 }, tintColor = { b = 0.3f, a = 0.75f }, content = SettingsText.Content.None } },
				{ "IntroDriverTextLayer6", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 27, position = { x = -179, y = 81 }, content = SettingsText.Content.Driver_QualifyPosition_Class, useClassColors = true } },
				...
				{ "LeaderboardPositionTextLayer4", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 21, alignment = TextAlignmentOptions.TopRight, position = { x = 298, y = 9 }, tintColor = { r = 0.69f, g = 0.71f, b = 0.694f }, content = SettingsText.Content.Driver_Telemetry } },
				{ "LeaderboardPositionTextLayer5", new SettingsText() { fontIndex = SettingsText.FontIndex.FontD, fontSize = 21, alignment = TextAlignmentOptions.TopLeft, position = { x = 330f, y = 12 }, tintColor = { r = 0.69f, g = 0.71f, b = 0.694f }, content = SettingsText.Content.Driver_ExtraInfo } },
				...
				{ "RaceResultPositionTextLayer1", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 60, alignment = TextAlignmentOptions.TopRight, position = { x = -854, y = 0 }, content = SettingsText.Content.Driver_Position_FinalResults } },
				{ "RaceResultPositionTextLayer2", new SettingsText() { fontIndex = SettingsText.FontIndex.FontB, fontSize = 21, alignment = TextAlignmentOptions.Top, position = { x = -800, y = 12 }, tintColor = { r = 0.69f, g = 0.71f, b = 0.694f }, content = SettingsText.Content.Driver_CarNumber } },
				{ "RaceResultPositionTextLayer3", new SettingsText() { fontIndex = SettingsText.FontIndex.FontB, fontSize = 60, position = { x = -675, y = 0 }, useClassColors = true, content = SettingsText.Content.Driver_FullName } },
				{ "RaceResultPositionTextLayer4", new SettingsText() { fontIndex = SettingsText.FontIndex.FontC, fontSize = 60, alignment = TextAlignmentOptions.TopRight, position = { x = 600, y = 0 }, tintColor = { r = 0.69f, g = 0.71f, b = 0.694f }, content = SettingsText.Content.FinishTime_Classsed } },
				{ "RaceResultPositionTextLayer5", new SettingsText() { fontIndex = SettingsText.FontIndex.FontC, fontSize = 60, alignment = TextAlignmentOptions.TopRight, position = { x = 830, y = 0 }, tintColor = { r = 0.69f, g = 0.71f, b = 0.694f }, content = SettingsText.Content.RacePoints } },
				{ "RaceResultPositionTextLayer6", new SettingsText() { fontIndex = SettingsText.FontIndex.FontC, fontSize = 40, alignment = TextAlignmentOptions.TopLeft, position = { x = 850, y = 5 }, tintColor = { r = 0.69f, g = 0.71f, b = 0.694f }, content = SettingsText.Content.RaceBounusPoints } },
				{ "RaceResultTextLayer1", new SettingsText() { fontIndex = SettingsText.FontIndex.FontB, fontSize = 50, alignment = TextAlignmentOptions.Top, position = { x = 0, y = 250 }, content = SettingsText.Content.Leaderboard_ClassName, useClassColors = true} },
				...
				{ "RaceStatusTextLayer1", new SettingsText() { fontIndex = SettingsText.FontIndex.FontD, fontSize = 27, position = { x = 18, y = 125 }, tintColor = { r = 0.961f, g = 0.961f, b = 0.953f }, content = SettingsText.Content.Session_Name } },
				{ "RaceStatusTextLayer2", new SettingsText() { fontIndex = SettingsText.FontIndex.FontD, fontSize = 27, alignment = TextAlignmentOptions.TopRight, position = { x = 269, y = 125 }, tintColor = { r = 0.961f, g = 0.961f, b = 0.953f }, content = SettingsText.Content.Session_LapsRemaining } },
				{ "RaceStatusTextLayer3", new SettingsText() { fontIndex = SettingsText.FontIndex.FontD, fontSize = 27, position = { x = 18, y = 175 }, tintColor = { r = 0.737f, g = 0.741f, b = 0.725f }, content = SettingsText.Content.Translation_Units } },
				{ "RaceStatusTextLayer4", new SettingsText() { fontIndex = SettingsText.FontIndex.FontD, fontSize = 27, alignment = TextAlignmentOptions.TopRight, position = { x = 298, y = 175 }, tintColor = { r = 0.737f, g = 0.741f, b = 0.725f }, content = SettingsText.Content.Session_CurrentLap } },
