	...
	public static class Settings
	{
		...
		public static void FixSettings( SettingsOverlay settings )
		{
			...
			var defaultImageSettings = new Dictionary<string, SettingsImage>() {
				...
				{ "RaceResultBackground", new SettingsImage() { imageType = SettingsImage.ImageType.ImageFile, filePath = Program.documentsFolder + "Assets\\default\\generic-background.png", position = { x = -1000, y = 0 }, size = { x = 2024, y = 104 }, border = { x = 24, y = 24, z = 24, w = 24 }, useClassColors = true } },
